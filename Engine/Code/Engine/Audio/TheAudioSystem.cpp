//---------------------------------------------------------------------------
#include "TheAudioSystem.hpp"


//-----------------------------------------------------------------------------------------------
TheAudioSystem* g_theAudioSystem = nullptr;


//---------------------------------------------------------------------------
TheAudioSystem::TheAudioSystem()
...
//
void TheAudioSystem::InitializeFMOD()
{
...
//---------------------------------------------------------------------------
SoundID TheAudioSystem::CreateOrGetSound( const std::string& soundFileName )
{
...
//---------------------------------------------------------------------------
void TheAudioSystem::StopChannel(AudioChannelHandle channel)
{
   if (channel != nullptr)
   {
...
//---------------------------------------------------------------------------
AudioChannelHandle TheAudioSystem::PlaySound(SoundID soundID, float volumeLevel/*=1.f */)
{
...
//---------------------------------------------------------------------------
AudioChannelHandle TheAudioSystem::PlayLoopingSound(SoundID soundID, float volumeLevel/*=1.f */)
{
   unsigned int numSounds = m_registeredSounds.size();
   if (soundID < 0 || soundID >= numSounds)
      return nullptr;
...
//---------------------------------------------------------------------------
void TheAudioSystem::ValidateResult( FMOD_RESULT result )
{
   if( result != FMOD_OK )
   {
